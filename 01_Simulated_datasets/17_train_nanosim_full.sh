...
GENOMES_LIST=$GENOMES_DIR/genome_list_training_full.tsv

READS=$WORKDIR/full_training_set/mapped_reads/full_mapped_reads.fastq
OUTDIR=$WORKDIR/nanosim_training_profile_FULL/nanosim_training_profile

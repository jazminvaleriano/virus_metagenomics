...
#SBATCH --qos=job_cpu
#SBATCH --array=0-4      # Adjust to the number of files minus 1
...
DB_DIR=/storage/research/vetsuisse_ivi/jvaleriano/Final_databases/DIAMOND_RefSeqViral/DIAMOND_RefSeqViral # DB file without extension .dmnd
MEGAN_DB=/storage/research/vetsuisse_ivi/jvaleriano/Final_databases/MEGAN_map2022/megan-map-Feb2022.db
OUT_DIR=1st_classification_results/diamond-megan

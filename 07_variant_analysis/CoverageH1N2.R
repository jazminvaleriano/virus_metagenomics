...
# ───── Input files ─────
bam_files <- c(
  "02_medaka/barcode35_swIAV_H1N2/calls_to_ref.bam",
  "02_medaka/barcode36_swIAV_H1N2/calls_to_ref.bam"
)
sample_names <- c("Barcode 35", "Barcode 36")
gff_file <- "genomes/swH1N2.gff3"
